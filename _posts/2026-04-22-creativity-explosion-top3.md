...
![번개 × 카드 × 코드 — 세 가지 미친 아이디어의 충돌]({{ site.baseurl }}/assets/images/2026-04-22-creativity-explosion-top3/hero-lightning-cards.webp)
...
![실제 번개 — 여러 가지가 동시에 뻗어나간 뒤, 하나만 살아남는다]({{ site.baseurl }}/assets/images/2026-04-22-creativity-explosion-top3/stepped-leader-photo.webp)
...
<div class="diagram-pair" markdown="1">

<div class="diagram-pair__item" markdown="1">
...
![카너먼의 Prospect Theory — Rust는 손실 영역에서 작동한다]({{ site.baseurl }}/assets/images/2026-04-22-creativity-explosion-top3/kahneman-prospect-theory.webp)
...
<figure class="bar-comparison">
  <figcaption class="bar-comparison__title">컴파일 타임 메모리 에러 탐지율 (2026)</figcaption>
  <div class="bar-comparison__row">
    <span class="bar-comparison__label">Rust</span>
    <div class="bar-comparison__track"><div class="bar-comparison__fill bar-comparison__fill--rust" style="width:83%;"><span>83%</span></div></div>
  </div>
  <div class="bar-comparison__row">
    <span class="bar-comparison__label">C++</span>
    <div class="bar-comparison__track"><div class="bar-comparison__fill bar-comparison__fill--cpp" style="width:32%;"><span>32%</span></div></div>
  </div>
  <figcaption class="bar-comparison__caption">51%p 차이 — 타입 시스템만으로 설명할 수 있을까?</figcaption>
</figure>
...
![Slay the Spire 카드 강화 — "유독 가스"의 중독이 2에서 3으로 변이한다]({{ site.baseurl }}/assets/images/2026-04-22-creativity-explosion-top3/slay-the-spire-card-upgrade.webp)
...
![DECK STATE SAVED — RPG 세이브 포인트처럼, 변이 전 상태를 저장한다]({{ site.baseurl }}/assets/images/2026-04-22-creativity-explosion-top3/save-point-pixel-art.webp)
...
![Discord #ai-창의성-폭발 채널 — AI가 매일 2번 자동으로 쏘는 아이디어]({{ site.baseurl }}/assets/images/2026-04-22-creativity-explosion-top3/discord-creativity-explosion.webp)
